...
{
    public class XiaomiViewModel : ViewModelBase
    {
        ...
        private void Log(string message)
        {
            ...
            _logger.LogInfo($"[XIAOMI] {message}");
        }

        private async Task DetectDeviceAsync()
        {
            IsBusy = true;
            StatusText = "Detecting Xiaomi device...";
            Progress = 30;
            ...
            if (fastbootDevices.Any())
            {
                ...
                _detectedDeviceInfo = new DeviceInfo { Model = "Xiaomi Fastboot", Mode = "Fastboot Mode", Serial = fb.SerialNumber };
        ...
        private async Task ReadInfoAsync()
        {
            ...
            Progress = 20;
            Log("Reading Xiaomi Device Information...");
            ...
            else
            {
                ...
                _notificationService.ShowNotification("Xiaomi", "Please detect device first.", NotificationType.Warning);
            }
        ...
        private async Task FlashRomAsync()
        {
            IsBusy = true;
            StatusText = "Flashing Fastboot ROM...";
            Log("Starting Xiaomi Fastboot ROM Flash...");
            ...
            Progress = 10;
            Log($"Analyzing ROM package at: {RomPath}...");
            await Task.Delay(1000);
