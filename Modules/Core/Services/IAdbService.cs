...
namespace UnlockMatePro.Services
{
    public interface IAdbService
    {
        ...
        Task<(bool Success, string Output)> ExecuteCommandAsync(string arguments, string? serialNumber = null, System.Threading.CancellationToken cancellationToken = default);
